...
time = '10000'  # str/float/int or 'latestTime'
...
# Absolute cap value for Sij and Rij; TB coefficients' basis
cap_sijrij = 1e9 # float
# Absolute cap for Tij
cap_tij = 1e9  # float
...
if proc_field and proc_field_raw:
    ...
    # FIXME: ALM_N_H_SeqTurb's bij is faulty thus no bij_les for SeqTurb in RANS either
    bij_les = field_data['bij'] if 'SeqTurb' not in casename else np.zeros((len(k), 6))
    del field_data
